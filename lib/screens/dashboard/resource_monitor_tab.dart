    ...
    return RefreshIndicator(
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final taskManagerButton = GlassCard(
          ...
          Widget resourceGauges = IntrinsicHeight(
            child: Row(
                ...
                children: [
                  ...
                  IntrinsicHeight(
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        // Left column: gauges + network/temp
                        Expanded(
                          flex: 1,
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
