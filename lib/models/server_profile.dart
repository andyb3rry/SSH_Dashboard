class ServerProfile {
  ...
  ServerProfile({
    ...
    this.customUpdateCommand = 'sudo apt-get update && sudo apt-get -y upgrade',
  ...
  factory ServerProfile.fromJson(Map<String, dynamic> json) {
    return ServerProfile(
      ...
      customUpdateCommand: json['customUpdateCommand']?.toString() ?? 'sudo apt-get update && sudo apt-get -y upgrade',
